...
(custom-set-variables
 ...
 '(package-selected-packages
   '(emacs-everywhere dashboard minimap company-box magit css-ls rainbow-delimiters counsel-projectile projectile typescript-mode shell-script-mode lsp-treemacs lsp-ui lsp-mode company spacemacs-theme which-key use-package)))
(custom-set-faces
