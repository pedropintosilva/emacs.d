...
(custom-set-variables
 ...
 '(package-selected-packages
   '(dashboard minimap company-box magit css-ls rainbow-delimiters counsel-projectile projectile typescript-mode lsp-treemacs lsp-ui lsp-mode company spacemacs-theme which-key use-package)))
(custom-set-faces
